    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content about-blue-bg-modal ">
        <div class="modal-body text-center">
          ...
          <br>
          <p>Video is taken about all aspects of village life, from culture and environment to food production, transportation, housing, healthcare and more.  This video is annotated for additional context and searchability.  At the same time, interviews are conducted to understand villager thoughts about local challenges, cultural sensitivities, and ideas for improvement.  This primary data is supplemented with a wide range of public information on the local culture, demographics, economy, health, climate, infrastructure, material availability and tool availability.  During the later Innovate step, specific physical measurements (eg size of a wheel, distance from A to B, etc) may be taken in support of particular projects.  All of this data is centrally stored and organized to be easily accessible during all of the subsequent steps to support Definition, Innovation and Impact.</p>
          <br>
